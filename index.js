...
//     image.animate({ opacity: 1, width: '100%', height: '100%' }, 2000, function() {
//         image.animate({ opacity: 1, width: '70%', height: '70%' }, 2000);
//     });
// });
$('.sd_2').click(function() {
let image = $('.cosmos_1');
...
function zoomImage() {
    if (counter < 2) {
        image.animate({ opacity: 1, width: '85%', height: '85%' }, 1500, function() {
            image.animate({ opacity: 1, width: '60%', height: '60%' }, 1500, function() {
                counter++;
                zoomImage();
            });
        });
...
// $('.modal_2 .close-fon_8').click(function(){
//     $('.fon_8').hide();
//     clearInterval(zoomInterval); // Останавливаем анимацию при закрытии модального окна
// });

// let image = $('.cosmos_1 img');
// let zoomInterval;
...
//         }
//     }, 1000); // Интервал анимации + ожидание
// });
...
//         }
//         large = !large;
//     }, 1000); // Изменим интервал для наглядности, 4 секунды на один проход
// }
